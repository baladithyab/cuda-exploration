...
define void @matmul_unchecked(ptr %v0, i64 %v1, ptr %v2, i64 %v3, ptr %v4, i64 %v5, i32 %v6) {
entry:
...
define void @matmul(ptr %v0, i64 %v1, ptr %v2, i64 %v3, ptr %v4, i64 %v5, i32 %v6) {
entry:
  %v7 = insertvalue { ptr, i64 } undef, ptr %v0, 0
  %v8 = insertvalue { ptr, i64 } %v7, i64 %v1, 1
  %v9 = insertvalue { ptr, i64 } undef, ptr %v2, 0
...
define void @matmul_fmuladd(ptr %v0, i64 %v1, ptr %v2, i64 %v3, ptr %v4, i64 %v5, i32 %v6) {
entry:
  %v7 = insertvalue { ptr, i64 } undef, ptr %v0, 0
  %v8 = insertvalue { ptr, i64 } %v7, i64 %v1, 1
  %v9 = insertvalue { ptr, i64 } undef, ptr %v2, 0
...
bb9:
  ...
  br label %bb10
bb10:
  %v36 = phi float [ 0.0, %bb9 ], [ %v48, %bb12 ]
  %v37 = phi i64 [ 0, %bb9 ], [ %v49, %bb12 ]
  %v38 = icmp ult i64 %v37, %v31
  %v39 = xor i1 %v38, 1
  br i1 %v39, label %bb13, label %bb11
bb11:
  %v40 = mul i64 %v32, %v31
  %v41 = add i64 %v40, %v37
  %v42 = getelementptr inbounds float, ptr %v34, i64 %v41
...
bb13:
  ...
  %v51 = mul i64 %v32, %v31
  %v52 = add i64 %v51, %v33
  %v53 = getelementptr inbounds float, ptr %v50, i64 %v52
  store float %v36, ptr %v53
  br label %bb14
bb14:
  ret void
}
...
@llvm.used = appending global [3 x ptr] [ptr @matmul_unchecked, ptr @matmul, ptr @matmul_fmuladd], section "llvm.metadata"

!0 = !{ptr @matmul_unchecked, !"kernel", i32 1}
!1 = !{ptr @matmul, !"kernel", i32 1}
!2 = !{ptr @matmul_fmuladd, !"kernel", i32 1}
